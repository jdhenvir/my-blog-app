...
export default function Profile(props) {
  return (
    <div className="gradient-custom-2" style={{ backgroundColor: "grey" }}>
          ...
          <MDBCol lg="9" xl="7">
            <MDBCard>
              <div
                ...
                style={{ backgroundColor: "darkorange", height: "200px" }}
              >
                <div
              ...
              <MDBCardBody className="text-black p-4">
                ...
                <MDBRow className="g-2">
                  <MDBCol className="mb-2">
                    <MDBCardImage
                      src="http://placebear.com/g/650/460"
                      alt="image 1"
                  ...
                  <MDBCol className="mb-2">
                    <MDBCardImage
                      src="http://placebear.com/650/460"
                      alt="image 1"
                      className="w-100 rounded-3"
                    />
                  </MDBCol>
                ...
                <MDBRow className="g-2">
                  <MDBCol className="mb-2">
                    <MDBCardImage
                      src="http://placekitten.com/650/460"
                      alt="image 1"
                      className="w-100 rounded-3"
                    />
                  </MDBCol>
                  <MDBCol className="mb-2">
                    <MDBCardImage
                      src="http://placekitten.com/g/650/460"
                      alt="image 1"
                      className="w-100 rounded-3"
                    />
                  </MDBCol>
